...
#define ACCESSTOKEN "textservertoken"
...
int main()
{
    ...
    string fileserver = "servicename:TextServer,servicetype:text,ipaddress:127.0.0.1,portnumber:" + to_string(PORT) + ",serviceaccesstoken:" + ACCESSTOKEN;
