...
#define ACCESSTOKEN "imageservertoken"
...
int main()
{
    ...
    string fileserver = "servicename:ImageServer,servicetype:image,ipaddress:127.0.0.1,portnumber:" + to_string(PORT) + ",serviceaccesstoken:" + ACCESSTOKEN;
